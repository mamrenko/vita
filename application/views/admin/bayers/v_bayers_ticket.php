  <div class="row">
      ...
      <?=HTML::anchor('admin/bayers/orders/'.$order->custom_id, '<button class="btn btn-info" type="button"><i class="fa fa-reply"></i> Вернуться на заказ  '.$customer->name.' </button>')?> 
         </p>
          <p>
  <?=HTML::anchor('admin/bayers', '<button class="btn btn-success" type="button"><i class="fa fa-reply"></i> Вернуться на список покупателей </button>')?>
	...
	<h3>
		<i class="fa fa-reorder"></i>
              ...
              <div class="portlet-content">
                   ...
                   <?=Form::open('admin/bayers/ticket_add', array(
         'id' => 'validate-basic',
