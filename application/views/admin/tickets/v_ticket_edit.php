...
<p>
      ...
      <?=HTML::anchor('admin/tickets/list/'.$ticket->event_id,
              '<button class="btn btn-info" type="button"><i class="fa fa-reply"></i> Вернуться</button>')?>
 ...
 <?=$event->playbill->title?> | 
  ...
  <div class="portlet-content">
      ...
      <?=Form::open('admin/tickets/edit/'.$ticket->id, array(
           'id' => 'validate-basic',
           ...
           'data-validate' => 'parsley',
              ...
              <select name="row" 
                      ...
                      >
              <?foreach($row as $rows):?>
              <option   selected value = "<?$data['row']?>"><?=$rows?></option>
              <?endforeach;?>
