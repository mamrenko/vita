...
<p>
      ...
      <?=HTML::anchor('admin/artists/list/'.$artist->place_id, '<button class="btn btn-info" type="button"><i class="fa fa-reply"></i>  Вернуться ' .$artist->place->title.' </button>')?>
     
</p>

<h3>Редактируем <?=$artist->name?> в труппе  <?=$artist->place->title?></h3>
            </div>
  <div class="portlet-content">
      
      <?=Form::open('admin/artists/edit/'. $id, array(
       ...
       <div class="form-group">
           ...
           <?=Form::hidden('place_id', $artist->place_id)?>
