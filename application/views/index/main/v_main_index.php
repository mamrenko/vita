...
<div class="row">
         ...
         <ul class="list-unstyled">
             <?foreach ($events as $event):?>
                ...
                <li class="col-md-4">
                <div class="thumbnail ">
                    <a href="event/<?=$event->playbill->id;?>">
 <?=HTML::image('media/uploads/playplaces/'.$event->playbill->image, array(
                ...
                <h4><?=HTML::anchor('event/'.$event->playbill->id,Text::limit_chars($event->playbill->title, 20));?></h4>
                <p><?=  Text::limit_chars($event->playbill->subtitle, 25 );?></p>
                <p>
                    <?=HTML::anchor('event/'.$event->playbill->id, 'Подробнее', array(
