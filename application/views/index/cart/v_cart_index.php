...
foreach ($products as $product):?>
        <tr>
            ...
            <td>
              <?=HTML::anchor('event/one/'.$product->playbill->id, $product->playbill->title)  ?>
            </td>
            <td>
                <?=HTML::anchor('places/place/'.$product->playbill->place->id, $product->playbill->place->title)?>
            </td>
            <td>
...
<div class="row">
    <div class="col-md-12">
         ...
         <p>
            ...
            Вы можете войти в <?=HTML::anchor('login', 'личный кабинет')?>  и продолжить оформление заказа на сайте.
        </p> 
    </div>
    <div class="col-md-8">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      <div class="form-group">
    <?=Form::label('lastname', 'Фамилия', array(
        'class' =>'col-sm-2 control-label',
    ...
    <div class="col-sm-10">
           <?=Form::input('lastname', $data['lastname'], array(
                   'class' => 'form-control',
                   'type' => 'text',
      ...
      <div class="form-group">
    <?=Form::label('firstname', 'Ваше имя', array(
        'class' =>'col-sm-2 control-label',
    ...
    <div class="col-sm-10">
           <?=Form::input('firstname', $data['firstname'], array(
                   'class' => 'form-control',
                   'type' => 'text',
   ...
   <div class="panel panel-info">
  <div class="panel-heading"><i class="fa fa-truck fa-2x"></i></i>&nbsp; Способ Доставки</div>
  <div class="panel-body">
      
      <div class="form-group">
          <?=
                    Form::radio('delivery',1, TRUE, array(
                        (bool) $data['delivery'],))
          ?>
          Доставка курьером
    ...
    <div class="panel panel-info">
  <div class="panel-heading"><i class="fa fa-rub fa-2x"></i>&nbsp; Способ Оплаты</div>
  <div class="panel-body">
      
      <div class="form-group">
          <?=
                    Form::radio('pay',1, TRUE, array(
                        (bool) $data['pay'],))
          ?>
          Наличными курьеру
