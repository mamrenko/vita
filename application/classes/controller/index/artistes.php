...
class Controller_Index_Artistes extends Controller_Index
{
...
//               $events = $events ->find_all();
        ...
        $calendar = Widget::load('calendar');
         ...
         $content = View::factory('index/artistes/v_artistes')
                  ->bind('artistes', $artistes)
